...
public:
    ...
    void run()
    {
        FILE* f1 = fopen(("../transE/"+result_path+"/relation2vec."+version).c_str(),"r");
        FILE* f3 = fopen(("../transE/"+result_path+"/entity2vec."+version).c_str(),"r");
    ...
    void entity_prediction()
    {
        ...
        FILE* file_e1_e2 = fopen("../experiment_data/e1_e2.txt","w");
